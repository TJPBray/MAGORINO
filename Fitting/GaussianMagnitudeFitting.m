function results = GaussianMagnitudeFitting (echotimes, tesla, Smagnitude, sig, GT, algoparams) %noise SD needed for Rician fit
%function outparams = GaussianMagnitudeFitting (echotimes, tesla, Smeasured, sig, GT, algoparams)
...
Gaussianfitting.solver=algoparams.solver;
Gaussianfitting.options=algoparams.options;

% Define the objective function
Gaussianfitting.objective = @(p) -R2Obj(p,echotimes,tesla,Smagnitude,sig);
...
Gaussianfitting.lb = algoparams.lb;
