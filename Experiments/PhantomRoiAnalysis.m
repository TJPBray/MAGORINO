...
hold on
plot(ReferenceValues.FF,ff.rician.mean,'x--','LineWidth',1)
plot(ReferenceValues.FF,0.01*ff.vendor.mean,'x--','LineWidth',1)
xlabel('Reference FF')
ylabel('PDFF')
legend('Gaussian fitting','Rician fitting','Hernando complex fitting')
xlim([0 1])
ylim([0 1])
